...
jstring
JNICALL
Java_com_example_jni_1test_MainActivity_getMessageFromNative(
        JNIEnv *env,
...
jfloat
JNICALL
Java_com_example_jni_1test_MainActivity_getMemberFieldFromNative(
        JNIEnv *env,
        jobject callingObject,
        jobject obj)
{
...
jint
JNICALL
Java_com_example_jni_1test_MainActivity_invokeMemberFuncFromNative(
        JNIEnv *env,
        jobject callingObject,
        jobject obj)
{
...
jobject
JNICALL
Java_com_example_jni_1test_MainActivity_createObjectFromNative(
        JNIEnv *env,
        jobject callingObject,
        jint param)
{
    jclass cls = env->FindClass("com/autodesk/adn/jnitester/com.example.jni_test.MeshData");
...
jint
JNICALL
Java_com_example_jni_1test_MainActivity_processObjectArrayFromNative(
        JNIEnv *env,
        jobject callingObject,
